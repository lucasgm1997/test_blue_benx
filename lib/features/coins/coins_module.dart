...
final coinsModule = [
  ...
  Provider<ICoinDataSource>(
      create: (context) => CoinGeckoApiDataSourceImp(
            context.read<Dio>(),
          )),
  Provider<ICoinRepository>(
      create: (context) => CoinRepositoryImp(
            context.read<ICoinDataSource>(),
          )),
  Provider<IFetchCoinsUsecase>(
      create: (context) => FetchCoinsUsecaseImp(
            context.read<ICoinRepository>(),
          )),
  Provider<IFetchBlueBenxCoinUsecase>(
      create: (context) => FetchBlueBenxCoinUsecaseImp(
            context.read<ICoinRepository>(),
          )),
];
